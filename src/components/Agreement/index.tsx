  ...
  return (
    <>
      ...
      <p className="important">
        Настоящее Соглашение определяет условия использования посетителем сайта
        (далее - Пользователь) материалов и сервисов сайта
        <a href="https://twfjournal.com" className="pointer">
          https://twfjournal.com
        </a>{' '}
        (далее - Сайт), а также регулирует отношения между ИП с основным
        государственным регистрационным номером
        <a>321385000070000</a> (далее TWFJ или Администрация) и посетителем
        сайта. Сайт{' '}
        <a href="https://twfjournal.com" className="pointer">
          https://twfjournal.com
        </a>{' '}
      ...
      <div className="content">
        ...
        <div className="info-block">
          ...
          <div className="info">
            ...
            <p>
              ...
              на сайте https://twfjournal.lol/ с помощью платежного метода -
            ...
            <p>
              ...
              30 (тридцать), сумма списания составляет 1000 (тысяча) или 1500
              (тысяча пятьсот) рублей, в зависимости от даты приобретения ключа.
            </p>
            <p>
              5.6. TWFJ оставляет за собой право в принятии решения о возврате
              или невозврате денежных средств. Возврат денежных средств
        ...
        <div className="info-block">
          <h2>7. Реквизиты</h2>
          <div className="info">
            <p>ИП Попов Никита Игоревич</p>
            <p>ОГРНИП 321385000070000</p>
            <p>ИНН 381120090053</p>
          </div>
        </div>

        <div className="info-block partners">
          <img
            src="/assets/img/user-agreement/payment.svg"
      ...
      <div className="agreement">
        ...
        <p className="important">
          ...
          ТОВАРОВ/РАБОТ/УСЛУГ ИП Попов Никита Игоревич ПОСРЕДСТВОМ РЕГУЛЯРНЫХ
          АВТОМАТИЧЕСКИХ ПЕРЕВОДОВ ДЕНЕЖНЫХ СРЕДСТВ.
        </p>

        <p className="important">
          ИП Попов Никита Игоревич зарегистрированный по адресу 443067, Россия,
          Иркутская область, г. Иркутс, действующий на основании свидетельства
          321385000070000, именуемый в дальнейшем Поставщик, предлагает
        ...
        <div className="content">
          <div className="info-block">
            ...
            <div className="info">
              <p>
                {' '}
                <span className="name">Сервис «Рекуррентные списания»</span> —
              ...
              <p>
                {' '}
                <span className="name">Договор</span> - двустороннее соглашение,
                заключенное между Пользователем и Поставщиком по условиям
                которого, Поставщик обязуется предоставить Пользователю Услугу,
                а последний обязуется оплатить их.
              </p>
              <p>
                {' '}
                <span className="name">Услуга/Товар</span> - предоставление
                Поставщиком услуги/товара по из ассортимента сайта{' '}
                <a href="https://twfjournal.com">https://twfjournal.com</a>
              </p>
              <p>
                {' '}
                <span className="name">Пользователь</span> — физическое лицо,
                заключившее Договор с Поставщиком.
              </p>
              <p>
                {' '}
                <span className="name">Банк</span> – кредитная организация — АО
                «Тинькофф Банк» БИК:044525974 К/с:30101810145250000974
              </p>
              <p>
                {' '}
                <span className="name">Запрос</span> – информационное сообщение,
                направляемое Банком в Банк-эмитент на перевод денежных средств с
                Банковской карты в пользу Поставщика.
              </p>
              <p>
                {' '}
                <span className="name">Банк-эмитент</span> — кредитная
              ...
              <p>
                {' '}
                <span className="name">Процессинговый центр</span> — АО
                «Тинькофф Банк» БИК:044525974 К/с:30101810145250000974
              </p>
              <p>
                {' '}
                <span className="name">Держатель карты</span> – физическое лицо,
                дающее распоряжение Банку-эмитенту на перевод денежных средств с
                Банковской карты от имени Пользователя в пользу Поставщика с
                помощью Сервиса «Рекуррентные списания».
              </p>
              <p>
                {' '}
                <span className="name">Банковская карта</span> — расчетная или
                кредитная карта, эмитентом которой является Банк-эмитент,
                являющаяся инструментом безналичных расчетов, предназначенная
                для совершения Держателем карты операций с денежными средствами,
                находящимися на банковских счетах Держателя карты в
                Банке-эмитенте, или с денежными средствами, предоставленными
                Банком-эмитентом в кредит Держателю карты в соответствии с
                законодательством Российской Федерации, а также договором
                банковского счета, или в пределах установленного лимита, в
                соответствии с условиями кредитного договора между
              ...
              <p>
                {' '}
                <span className="name">Акцепт Пользователя</span> – безусловное
                согласие Пользователя с условиями настоящего Соглашения.
              </p>
              <p>
                {' '}
                <span className="name">Личный кабинет</span> – раздел Сайта
                Поставщика, защищенный системой контроля доступа, обеспечивающий
                Пользователю интерфейс для взаимодействия с Поставщиком по
                Договору.
              </p>
              <p>
                {' '}
                <span className="name">Сайт Поставщика</span> - сайт,
